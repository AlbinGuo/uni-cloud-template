  ...
  return _c(
    ...
    _vm._l(_vm._$s(1, "f", { forItems: _vm.tabList }), function(
      ...
      return _c(
        ...
        [
          _c("list-item", {
            attrs: { list: _vm.cacheListData[index], _i: "2-" + $30 },
...
"use strict";
eval("/* WEBPACK VAR INJECTION */(function(__f__) {Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0;var _regenerator = _interopRequireDefault(__webpack_require__(/*! ./node_modules/@babel/runtime/regenerator */ 11));\n\n\n\n\n\n\n\n\nvar _listItem = _interopRequireDefault(__webpack_require__(/*! @/components/list/list-item.vue */ 14));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _toConsumableArray(arr) {return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _unsupportedIterableToArray(arr) || _nonIterableSpread();}function _nonIterableSpread() {throw new TypeError(\"Invalid attempt to spread non-iterable instance.\\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.\");}function _unsupportedIterableToArray(o, minLen) {if (!o) return;if (typeof o === \"string\") return _arrayLikeToArray(o, minLen);var n = Object.prototype.toString.call(o).slice(8, -1);if (n === \"Object\" && o.constructor) n = o.constructor.name;if (n === \"Map\" || n === \"Set\") return Array.from(o);if (n === \"Arguments\" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen);}function _iterableToArray(iter) {if (typeof Symbol !== \"undefined\" && Symbol.iterator in Object(iter)) return Array.from(iter);}function _arrayWithoutHoles(arr) {if (Array.isArray(arr)) return _arrayLikeToArray(arr);}function _arrayLikeToArray(arr, len) {if (len == null || len > arr.length) len = arr.length;for (var i = 0, arr2 = new Array(len); i < len; i++) {arr2[i] = arr[i];}return arr2;}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err);}_next(undefined);});};}var _default2 =\n{\n  name: \"list\",\n  components: {\n    ListItem: _listItem.default },\n\n  props: {\n    tabList: {\n      type: Array,\n      default: function _default() {\n        return [];\n      } },\n\n    activeIndex: {\n      type: Number,\n      default: 0 } },\n\n\n  data: function data() {\n    return {\n      list: [],\n      cacheListData: {}, // 缓存数据\n      page: 1,\n      pageSize: 10 };\n\n  },\n  created: function created() {\n\n  },\n  watch: {\n    tabList: function tabList(newVal, oldVal) {\n      if (newVal.length === 0) return;\n      this.getList(this.activeIndex);\n    } },\n\n  methods: {\n    loadMore: function loadMore() {\n      try {\n        this.page++;\n        __f__(\"log\", '===this.activeIndex', this.activeIndex, \" at components/list/list.vue:49\");\n        var list = this.getList(this.activeIndex);\n        __f__(\"log\", '===list.data', list, \" at components/list/list.vue:51\");\n      } catch (e) {\n        __f__(\"log\", \"e==\", e, \" at components/list/list.vue:53\");\n      }\n    },\n    change: function change(e) {var\n      current = e.detail.current;\n      this.$emit(\"change\", current);\n      // 当数据不存在或者数据为空的情况下采取请求数据\n      if (!this.cacheListData[current] || this.cacheListData[current].length === 0) {\n        this.getList(current);\n      }\n    },\n    getList: function getList(current) {var _this = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var name, list, oldList;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:_context.prev = 0;\n\n                name = _this.tabList[current].name;_context.next = 4;return (\n                  _this.$api.getList({\n                    name: name,\n                    page: _this.page,\n                    pageSize: _this.pageSize }));case 4:list = _context.sent;\n\n                // 分页push数据\n                oldList = _this.cacheListData[current] || [];\n                oldList.push.apply(oldList, _toConsumableArray(list.data));\n                _this.$set(_this.cacheListData, current, oldList);\n                // this.cacheListData[current] = list.data \n                _context.next = 13;break;case 10:_context.prev = 10;_context.t0 = _context[\"catch\"](0);\n                __f__(\"error\", _context.t0, \" at components/list/list.vue:78\");case 13:case \"end\":return _context.stop();}}}, _callee, null, [[0, 10]]);}))();\n\n    } } };exports.default = _default2;\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/vue-cli-plugin-uni/lib/format-log.js */ 10)[\"default\"]))//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///9\n");
    ...
    [
      _c(
        ...
        [
          ...
          _c("uni-load-more", {
            attrs: { iconType: "snow", status: "noMore", _i: 4 }
          })
        ],
        1
      )
...
"use strict";
eval("Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0; //\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\nvar _default2 =\n{\n  name: \"list-item\",\n  props: {\n    list: {\n      type: Array,\n      default: function _default() {\n        return [];\n      } } },\n\n\n  data: function data() {\n    return {};\n\n  },\n  methods: {} };exports.default = _default2;//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///40\n");
